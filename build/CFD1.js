...
// include: /tmp/emscripten_temp/tmp6ma0pnrm.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/aidar/CLionProjects/CFD/CFD1/build/CFD1.data';
      var REMOTE_PACKAGE_BASE = 'CFD1.data';
...
Module['FS_createPath']("/", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/home/aidar/CLionProjects/CFD/CFD1/build/CFD1.data');

      };
      Module['addRunDependency']('datafile_/home/aidar/CLionProjects/CFD/CFD1/build/CFD1.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/cfd_frag.wgsl", "start": 0, "end": 272}, {"filename": "/shaders/frag.wgsl", "start": 272, "end": 662}, {"filename": "/shaders/picking.frag", "start": 662, "end": 779}, {"filename": "/shaders/picking.vert", "start": 779, "end": 1326}, {"filename": "/shaders/step1Compute.wgsl", "start": 1326, "end": 4698}, {"filename": "/shaders/step2Compute.wgsl", "start": 4698, "end": 7644}, {"filename": "/shaders/step3Compute.wgsl", "start": 7644, "end": 9888}, {"filename": "/shaders/step4Compute.wgsl", "start": 9888, "end": 10584}, {"filename": "/shaders/step5Compute.wgsl", "start": 10584, "end": 11358}, {"filename": "/shaders/step6Compute.wgsl", "start": 11358, "end": 13083}, {"filename": "/shaders/vert.wgsl", "start": 13083, "end": 14008}], "remote_package_size": 14008});

  })();

// end include: /tmp/emscripten_temp/tmp6ma0pnrm.js
// include: /tmp/emscripten_temp/tmphbpb59hn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/emscripten_temp/tmphbpb59hn.js
// include: /tmp/emscripten_temp/tmp8mowhre1.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/emscripten_temp/tmp8mowhre1.js
...
var ASM_CONSTS = {
 ...
 139054: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 139137: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 139206: () => { return window.innerWidth; },  
 139236: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
...
var ___heap_base = Module['___heap_base'] = 159616;
